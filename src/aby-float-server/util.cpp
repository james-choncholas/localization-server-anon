...
void PrintSumTimings(int x) {
    ...
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_total", x, sumTimes[P_TOTAL].timing);
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_init", x, sumTimes[P_INIT].timing);
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_circuit", x, sumTimes[P_CIRCUIT].timing);
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_network", x, sumTimes[P_NETWORK].timing);
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_baseot", x, sumTimes[P_BASE_OT].timing);
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_setup", x, sumTimes[P_SETUP].timing);
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_otext", x, sumTimes[P_OT_EXT].timing);
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_garble", x, sumTimes[P_GARBLE].timing);
    MSG("SeNtInAl,xy,%s,%s,%d,%g\n", __FUNCTION__, "gngd_online", x, sumTimes[P_ONLINE].timing);
    for (int phase=P_FIRST; phase<=P_LAST; phase++) {
