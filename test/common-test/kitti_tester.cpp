...
const static char* dataset_images_location = "../../data-kitti/dataset/sequences/00/image_1";
const static char* dataset_poses_location = "../../data-kitti/dataset/poses/poses/00.txt";
