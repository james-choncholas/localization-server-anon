...
int main(int argc, char** argv) {
  ...
  std::vector<e_sharing> ctypes = {/*S_ARITH,*/ S_BOOL,
                                   S_YAO};  // cant do floats with arith
      ...
      for (int i = 6; i < test_num_pts;
        ...
        for (int t = 0; t < NUM_TRIALS; t++) {
...

          {
            ...
            // test_gaussnewton_circuit(role, address, port, seclvl, nthreads,
            // mt_alg, S_BOOL,
            //     objectPointsSubset, imagePointsSubset, f, cx, cy,
            //     &initialGuessCopy[0]);
...

          {
            ...
            // test_lm_circuit(role, address, port, seclvl, nthreads, mt_alg,
            // S_BOOL,
            //     objectPointsSubset, imagePointsSubset, f, cx, cy,
            //     &initialGuessCopy[0]);
            float error[6];
