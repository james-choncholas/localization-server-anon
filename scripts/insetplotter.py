...
def plot(csvFilePaths, options, tags):
    ...
    if options.title == "Runtime per Iteration":
      mysubax = zoomed_inset_axes(myax, 3, bbox_to_anchor=(64,120), loc=2, borderpad=0) # zoom = 6
    elif options.title == "Network IO per Iteration":
      mysubax = zoomed_inset_axes(myax, 3, bbox_to_anchor=(64,140), loc=2, borderpad=0) # zoom = 6
