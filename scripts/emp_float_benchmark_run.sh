...
# short run
$scriptpath/../build/bin/emp_float_eth3d_bench gn 5 6 12 | tee $scriptpath/../results/gn_emp_float_eth3d_bench_short.log
$scriptpath/../build/bin/emp_float_eth3d_bench lm 5 6 12 | tee $scriptpath/../results/lm_emp_float_eth3d_bench_short.log
