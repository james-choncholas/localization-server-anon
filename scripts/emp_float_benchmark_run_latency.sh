...
# long run only
$scriptpath/../build/bin/emp_float_server_convergence gn 1 1 256 | tee $scriptpath/../results/gn_emp_float_server_benchmark_long_latency.log
$scriptpath/../build/bin/emp_float_server_convergence lm 1 1 256 | tee $scriptpath/../results/lm_emp_float_server_benchmark_long_latency.log
