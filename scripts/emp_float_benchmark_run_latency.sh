...
# long run only
$scriptpath/../build/bin/emp_float_eth3d_bench gn 3 2 256 | tee $scriptpath/../results/gn_emp_float_eth3d_bench_long_latency.log
$scriptpath/../build/bin/emp_float_eth3d_bench lm 3 2 256 | tee $scriptpath/../results/lm_emp_float_eth3d_bench_long_latency.log
